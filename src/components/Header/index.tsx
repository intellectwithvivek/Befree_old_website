    ...
    <>
      <div className={styles.container}>
        ...
        <Modal open={open} onClose={handleClose}>
          ...
          <Box
            sx={style}>
            <Typography variant="h5" component="h2" mb={2} sx={{color:colors.primary,fontWeight:700}}>
              Login
            </Typography>

            {confirmation && <h6
              className={styles.sentNumber}>
            ...
            <Box display="flex" flexDirection={"column"} alignItems={"center"}>
                ...
                InputProps={{
                  startAdornment: (
                    <Box display="flex" alignItems="center" sx={{ marginRight: '1rem' }}>
                      ...
                      <Typography variant="inherit" sx={{ marginLeft: '.5rem', fontSize: '1.2rem' }}>+91</Typography>
                      {/* Add your flag icon here */}
                    </Box>
                  ),
                }}
                helperText={loginErrors?.phone?"Please check your number.":null}
              />
              ...
              {!confirmation ? <Button
                ...
                sx={{ marginTop:'1.5rem' }}
              >
                {sending && <CircularProgress size={15} sx={{marginRight:'.5rem'}}/>} Send OTP
              </Button>
                : <div>
                  ...
                  <Box display="flex" alignItems={'center'} justifyContent={"space-between"}>
                    {otp.map((digit, index) => (
                      <TextField
                        ...
                        style={{ width: '5rem', marginBottom: '3.5rem', margin: '2rem', fontSize: '1.5rem' }}
                  ...
                  {loginErrors?.otp && <Typography 
                        variant="inherit"
                        sx={{color:colors.error,fontSize:'1.2rem',marginTop:'0.8rem',marginBottom:'0.8rem'}}>OTP is not correct</Typography>}
                  <Button
                    variant="contained"
                    color="primary"
                    onClick={onOTPVerify}
                  ...
                  >
                    {verifying && <CircularProgress size={15} sx={{marginRight:'.5rem'}}/>} {verifying?"Verifying ..":"Verify OTP"}
                  </Button>
                  ...
                  <Box display="flex" alignItems="center" justifyContent="space-between">
                    ...
                    <Typography variant="body2" color="textSecondary">
                      {resendTimer > 0 ? `Resend in ${resendTimer} seconds` : (
                        <Button
                          variant="outlined"
                          color="primary"
