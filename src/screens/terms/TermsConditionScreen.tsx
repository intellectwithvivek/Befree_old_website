    ...
    <>
      <div className={styles.termContainer}>
        ...
        <p>We are committed to ensuring that the app is as useful and efficient as possible. For that reason, we reserve the right to make changes to the app or to charge for its services, at any time and for any reason. We will never charge you for the app or its services without making it very clear to you exactly what you’re paying for.
          The befree app stores and processes personal data that you have provided to us, to provide my Service. It’s your responsibility to keep your phone and access to the app secure. We therefore recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that the befree app won’t work properly or at all.</p>
        <p>
        ...
        Link to Terms and Conditions of third-party service providers used by the app
          ...
          <ul>
              ...
              <a href="https://cloud.google.com/terms/" 
                        target="_blank" className={styles.links}>Google Cloud Platform</a>
              </li>
              <li>
              <a href="https://firebase.google.com/terms/data-processing-terms" 
                      target="_blank" className={styles.links}>Firebase Data Processing and Security Terms</a>
            </li>
            <li>
              <a href="https://razorpay.com/terms/" 
                      target="_blank" className={styles.links}>RazorPay</a>
            </li>
            <li>
              <a href="https://docs.microsoft.com/en-us/legal/termsofuse" 
                      target="_blank" className={styles.links}>AppCenter</a>
            </li>
          </ul>
          ...
          <p>These terms and conditions are effective as of 2022-06-01</p>
          <h3>Contact Us</h3>
          <p>If you have any questions or suggestions about my Terms and Conditions, do not hesitate to contact me at betabefree340@gmail.com.</p>
      </div>
