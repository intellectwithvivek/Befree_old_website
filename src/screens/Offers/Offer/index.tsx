...
import { Offer_Types, OffersWork, boostYourBusinessContent } from '../../../constants/app_constants'
...
export default function Offer({ }: Props) {
    ...
    if(offer_type.trim().toLowerCase() === Offer_Types.DISCOUNT.title.trim().toLowerCase())
    {
        ...
        <div className={styles.container}>
            ...
            <div className={styles.offerContainerCenter}>
                {Object.keys(Offer_Types).map(item => {
                    return (<OfferCard offerType={Offer_Types?.[item]} 
                            onSelect={() => {
            ...
            <div className={styles.offerContainer}>
                ...
                <div className={styles.boostContainer}>
                    {boostYourBusinessContent?.map((item, index) => {
                        return (<div key={index} className={index==1?styles.boostItem1:styles.boostItem}>
                           <div>
                           <h3>{item.title}</h3>
                            <ul>
                           ...
                           <div style={containerStyle}>
                            <Lottie options={boostAnimeOptions[index]}
                                // height={300}
                                // width={300}
