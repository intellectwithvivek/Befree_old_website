...
class UserDetailServices {
  ...
  public registerUser = (merchant: Merchant): Promise<AxiosResponse<RegisterResponse>> =>
  axiosInstance.post('/public/registerMerchant', merchant);

  public initializeMerchant = (merchant: Merchant): Promise<AxiosResponse<Merchant>> =>
  axiosInstance.post('/private/merchant/merchantInfoInitialize', merchant);


  public getMerchantInfo = (username: string): Promise<AxiosResponse<Merchant>> =>
  axiosInstance.get(`/private/merchant/merchantInfo/${username}`);

  public verifyMerchantInfo = (merchant: Merchant): Promise<AxiosResponse<Merchant>> =>
...
//------------ end -----------------------
  ...
  public getUserInfoByPhone = (phone: string): Promise<AxiosResponse<Merchant>> =>
    axiosInstance.get(`/private/merchant/tagInfo/${phone}`);

  public getUserInfoNormal = (username: string, access_token: string): Promise<AxiosResponse<Merchant>> =>
  ...
  public saveUserLocationDetails = (locData: any): Promise<AxiosResponse< any>> =>
    axiosInstance.post('/private/merchant/locationInfo', locData);



  public deleteUser = (username: string): Promise<AxiosResponse<AxiosResponse>> =>
    axiosInstance.post(`/private/merchant/deleteUser/${username}`);  
    
  public undeleteUser = (username: string): Promise<AxiosResponse<AxiosResponse>> =>
  axiosInstance.post(`/private/merchant/undeleteUser/${username}`);  
  
  
  public updateUserName = (username: string,name:string): Promise<AxiosResponse<Merchant>> =>
